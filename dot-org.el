...
;;; Org agenda custom commands (Bernt Hansen style)
;; Moved out of custom-set-variables so load-theme doesn't reset them.
;; Uses add-to-list so jira commands from work.el aren't overwritten.
(with-eval-after-load 'org-agenda
  (dolist (cmd '(("N" "Notes" tags "NOTE"
