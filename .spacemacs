...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(org-capture-templates
     '(("t" "todo" entry (file+headline "/Users/dhaley/Library/CloudStorage/Box-Box/projects/todo.txt" "Inbox")
        "* TODO %?\nSCHEDULED: %t\n:PROPERTIES:\n:ID:       %(shell-command-to-string \"uuidgen\"):CREATED:  %U\n:END:\n" :prepend t)
       ("a" "article" entry (file+headline "/Users/dhaley/Library/CloudStorage/Box-Box/projects/todo.txt" "Inbox")
        "* TODO %?\nSCHEDULED: %t\n:PROPERTIES:\n:ID:       %(shell-command-to-string \"uuidgen\"):CREATED:  %U\n:END:\n" :prepend t)
       ("r" "respond" entry (file+headline "/Users/dhaley/Library/CloudStorage/Box-Box/projects/todo.txt" "Inbox")
       ...
       ("J" "Jira Task" entry (file+headline "/Users/dhaley/Library/CloudStorage/Box-Box/projects/todo.txt" "Org Jira")
        "* TODO [#B] %^{Summary}\nSCHEDULED: %t\n:PROPERTIES:\n:assignee: Haley, Damon\n:filename: co-dhaley\n:reporter: Haley, Damon\n:type:     Task\n:type-id:  3\n:priority: Major\n:status:   Ready\n:created:  %U\n:updated:  %U\n:sprint:   %(org-jira--capture-default-sprint)\n:labels:   \n:components: \n:ID:       %(shell-command-to-string \"uuidgen\"):CUSTOM_ID: \n:story-points: %^{Story Points|1}\n:epic:     %^{Epic Key|CO-9686}\n:epic-name: %^{Epic Name|OPS INT - Appfleet 2.0}\n:servicenow-link: \n:epic-short: %^{Epic Short|OPS INT - Appfleet 2.0}\n:jira-project: CO\n:jira-type: Task\n:jira-priority: Major\n:jira-assignee: dhaley\n:jira-epic: %\\4\n:jira-sprint: %(org-jira--capture-default-sprint)\n:jira-component: \n:jira-labels: \n:jira-story-points: %\\3\n:jira-due-date: %(org-jira--capture-default-due-date)\n:jira-servicenow-link: \n:jira-task-number: \n:jira-contact-email: \n:jira-fix-version: \n:END:\n*** description\n%?" :prepend t)))
